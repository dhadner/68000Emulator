...
namespace PendleCodeMonkey.MC68000Emulator.Tests
{
    ...
    public class DisassemblerTests
    {
        ...
        [InlineData("00401C0E", "43F900EFE1FE    	", "LEA.L  ", "($00efe1fe).L,A1     ")]
        [InlineData("00401C14", "137C00090600    	", "MOVE.B ", "#$0009,(1536,A1)     ")]
        [InlineData("00401C1A", "10291E00        	", "MOVE.B ", "(7680,A1),D0         ")]
        [InlineData("00401C1E", "08C00003        	", "BSET.L ", "#3,D0                ")]
        [InlineData("00401C22", "13401E00        	", "MOVE.B ", "D0,(7680,A1)         ")]
        [InlineData("00401C26", "08070018        	", "BTST.L ", "#24,D7               ")]
        [InlineData("00401C2A", "66000176        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401C2E", "45F900EFE1FE    	", "LEA.L  ", "($00efe1fe).L,A2     ")]
        [InlineData("00401C34", "102A1E00        	", "MOVE.B ", "(7680,A2),D0         ")]
        [InlineData("00401C38", "08800000        	", "BCLR.L ", "#0,D0                ")]
        [InlineData("00401C3C", "15401E00        	", "MOVE.B ", "D0,(7680, A2)        ")]
        [InlineData("00401C40", "102A1E00        	", "MOVE.B ", "(7680,A2),D0         ")]
        [InlineData("00401C44", "08000001        	", "BTST.L ", "#1,D0                ")]
        [InlineData("00401C48", "6616            	", "BNE.B  ", "$00401c60            ")]
        [InlineData("00401C4A", "08C00000        	", "BSET.L ", "#0,D0                ")]
        [InlineData("00401C4E", "15401E00        	", "MOVE.B ", "D0,(7680, A2)        ")]
        [InlineData("00401C52", "102A1E00        	", "MOVE.B ", "(7680,A2),D0         ")]
        ...
        [InlineData("00401C74", "45F9005FF000    	", "LEA.L  ", "($005ff000).L,A2     ")]
        [InlineData("00401C7A", "102A0010        	", "MOVE.B ", "(16,A2),D0           ")]
        [InlineData("00401C7E", "08070018        	", "BTST.L ", "#24,D7               ")]
        [InlineData("00401C82", "6600011E        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401C86", "45F900DFE1FF    	", "LEA.L  ", "($00dfe1ff).L,A2     ")]
        [InlineData("00401C8C", "4A2A1C00        	", "TST.B  ", "(7168,A2)            ")]
        [InlineData("00401C90", "102A1A00        	", "MOVE.B ", "(6656,A2),D0         ")]
        ...
        [InlineData("00401D4C", "45F900080000    	", "LEA.L  ", "($00080000).L,A2     ")]
        [InlineData("00401D52", "0C8000100000    	", "CMPI.L ", "#$00100000,D0        ")]
        [InlineData("00401D58", "6F06            	", "BLE.B  ", "$00401d60            ")]
        [InlineData("00401D5A", "45F900200000    	", "LEA.L  ", "($00200000).L,A2     ")]
        ...
        [InlineData("00401DE4", "22680008        	", "MOVEA.L", "(8,A0),A1            ")]
        [InlineData("00401DE8", "20680004        	", "MOVEA.L", "(4,A0),A0            ")]
        ...
        [InlineData("00401E48", "22680008        	", "MOVEA.L", "(8,A0),A1            ")]
        [InlineData("00401E4C", "20680004        	", "MOVEA.L", "(4,A0),A0            ")]
