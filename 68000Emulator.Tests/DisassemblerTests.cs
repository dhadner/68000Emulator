...
#pragma warning restore IDE0079 // Remove unnecessary suppression
    ...
    public class DisassemblerTests
    {
        ...
        [Theory]                                    
        [InlineData("00010000", "3E7C1800           ", "MOVEA.W", "#$1800,SP            ")]
        [InlineData("00010004", "7000               ", "MOVEQ.L", "#0,D0                ")]
        [InlineData("00010006", "21C01800           ", "MOVE.L ", "D0,($00001800).W     ")]
        [InlineData("0001000A", "21C01804           ", "MOVE.L ", "D0,($00001804).W     ")]
        [InlineData("0001000E", "21C01808           ", "MOVE.L ", "D0,($00001808).W     ")]
        [InlineData("00010012", "7001               ", "MOVEQ.L", "#1,D0                ")]         
        [InlineData("00010014", "21C0180C           ", "MOVE.L ", "D0,($0000180c).W     ")]
        [InlineData("00010018", "103C0080           ", "MOVE.B ", "#$80,D0              ")]
        [InlineData("0001001C", "11C01810           ", "MOVE.B ", "D0,($00001810).W     ")]
        [InlineData("00010054", "11C01817           ", "MOVE.B ", "D0,($00001817).W     ")]
        [InlineData("00010058", "4E550000           ", "LINK   ", "A5,#0                ")]
        [InlineData("0001005C", "20381800           ", "MOVE.L ", "($00001800).W,D0     ")]
        [InlineData("00010060", "5280               ", "ADDQ.L ", "#1,D0                ")]
        [InlineData("00010062", "21C01800           ", "MOVE.L ", "D0,($00001800).W     ")]
        ...
        [InlineData("0003801C", "183900E80000       ", "MOVE.B ", "($00e80000).L,D4     ")]
        [InlineData("00038022", "1C3900030002       ", "MOVE.B ", "($00030002).L,D6     ")]
        [InlineData("00038028", "670000E6           ", "BEQ.W  ", "$00038110            ")]
        [InlineData("0003802C", "207C00030003       ", "MOVEA.L", "#$00030003,A0        ")]
        [InlineData("00038032", "283900030001       ", "MOVE.L ", "($00030001).L,D4     ")]
        [InlineData("00038038", "1C3900030003       ", "MOVE.B ", "($00030003).L,D6     ")]
        [InlineData("0003803E", "670000D0           ", "BEQ.W  ", "$00038110            ")]
        [InlineData("00038042", "207C00030004       ", "MOVEA.L", "#$00030004,A0        ")]
        [InlineData("00038048", "4AFC               ", "ILLEGAL", "                     ")]
        [InlineData("0003804A", "1C3900030004       ", "MOVE.B ", "($00030004).L,D6     ")]
        [InlineData("00038050", "670000BE           ", "BEQ.W  ", "$00038110            ")]
        ...
        [InlineData("00038060", "1C3900030005       ", "MOVE.B ", "($00030005).L,D6     ")]
        [InlineData("00038066", "670000A8           ", "BEQ.W  ", "$00038110            ")]
        ...
        [InlineData("0003807A", "1C3900030006       ", "MOVE.B ", "($00030006).L,D6     ")]
        [InlineData("00038080", "6700008E           ", "BEQ.W  ", "$00038110            ")]
        ...
        [InlineData("00038094", "1C3900030007       ", "MOVE.B ", "($00030007).L,D6     ")]
        [InlineData("0003809A", "6774               ", "BEQ.B  ", "$00038110            ")]
        [InlineData("0003809C", "6068               ", "BRA.B  ", "$00038106            ")]
        [InlineData("0003809E", "321F               ", "MOVE.W ", "(SP)+,D1             ")]
        [InlineData("000380A0", "241F               ", "MOVE.L ", "(SP)+,D2             ")]
        [InlineData("000380A2", "361F               ", "MOVE.W ", "(SP)+,D3             ")]
        [InlineData("000380A4", "1C3C0001           ", "MOVE.B ", "#$01,D6              ")]
        [InlineData("000380A8", "13C600030002       ", "MOVE.B ", "D6,($00030002).L     ")]
        ...
        [InlineData("000380B6", "1C3C0001           ", "MOVE.B ", "#$01,D6              ")]
        [InlineData("000380BA", "13C600030003       ", "MOVE.B ", "D6,($00030003).L     ")]
        [InlineData("000380C0", "4E73               ", "RTE    ", "                     ")]
        [InlineData("000380C2", "1C3C0001           ", "MOVE.B ", "#$01,D6              ")]
        [InlineData("000380C6", "13C600030004       ", "MOVE.B ", "D6,($00030004).L     ")]
        [InlineData("000380CC", "4E73               ", "RTE    ", "                     ")]
        [InlineData("000380CE", "1C3C0001           ", "MOVE.B ", "#$01,D6              ")]
        [InlineData("000380D2", "13C600030005       ", "MOVE.B ", "D6,($00030005).L     ")]
        [InlineData("000380D8", "4E73               ", "RTE    ", "                     ")]
        [InlineData("000380DA", "1C3C0001           ", "MOVE.B ", "#$01,D6              ")]
        [InlineData("000380DE", "13C600030006       ", "MOVE.B ", "D6,($00030006).L     ")]
        [InlineData("000380E4", "4E73               ", "RTE    ", "                     ")]
        [InlineData("000380E6", "1C3C0001           ", "MOVE.B ", "#$01,D6              ")]
        [InlineData("000380EA", "13C600030007       ", "MOVE.B ", "D6,($00030007).L     ")]
        [InlineData("000380F0", "4E73               ", "RTE    ", "                     ")]
        [InlineData("000380F2", "223C22222222       ", "MOVE.L ", "#$22222222,D1        ")]
        [InlineData("000380F8", "1C3C0001           ", "MOVE.B ", "#$01,D6              ")]
        [InlineData("000380FC", "13C600030008       ", "MOVE.B ", "D6,($00030008).L     ")]
        ...
        [InlineData("00401BE2", "3E7C2000        	", "MOVEA.W", "#$2000,SP            ")]
        ...
        [InlineData("00401BF0", "203900F80000    	", "MOVE.L ", "($00f80000).L,D0     ")]
        [InlineData("00401BF6", "B081            	", "CMP.L  ", "D1,D0                ")]
        [InlineData("00401BF8", "660A            	", "BNE.B  ", "$00401c04            ")]
        [InlineData("00401BFA", "4CF9010100F80000	", "MOVEM.L", "($00f80000).L,D0/A0  ")]
        ...
        [InlineData("00401C0E", "43F900EFE1FE    	", "LEA    ", "($00efe1fe).L,A1     ")]
        [InlineData("00401C14", "137C00090600    	", "MOVE.B ", "#$09,$0600(A1)       ")]
        ...
        [InlineData("00401C2A", "66000176        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401C2E", "45F900EFE1FE    	", "LEA    ", "($00efe1fe).L,A2     ")]
        ...
        [InlineData("00401C48", "6616            	", "BNE.B  ", "$00401c60            ")]
        ...
        [InlineData("00401C5A", "6704            	", "BEQ.B  ", "$00401c60            ")]
        [InlineData("00401C5C", "08C7001A        	", "BSET.L ", "#26,D7               ")]
        [InlineData("00401C60", "3E3C0001        	", "MOVE.W ", "#$0001,D7            ")]
        [InlineData("00401C64", "4DFA0008        	", "LEA    ", "$00401c6e(PC),A6     ")]
        [InlineData("00401C68", "60000A60        	", "BRA.W  ", "$004026ca            ")]
        [InlineData("00401C6C", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401C6E", "66000132        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401C72", "4247            	", "CLR.W  ", "D7                   ")]
        [InlineData("00401C74", "45F9005FF000    	", "LEA    ", "($005ff000).L,A2     ")]
        [InlineData("00401C7A", "102A0010        	", "MOVE.B ", "$0010(A2),D0         ")]
        [InlineData("00401C7E", "08070018        	", "BTST.L ", "#24,D7               ")]
        [InlineData("00401C82", "6600011E        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401C86", "45F900DFE1FF    	", "LEA    ", "($00dfe1ff).L,A2     ")]
        ...
        [InlineData("00401C98", "66000108        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401C9C", "3E3C000E        	", "MOVE.W ", "#$000e,D7            ")]
        [InlineData("00401CA0", "4DFA0008        	", "LEA    ", "$00401caa(PC),A6     ")]
        [InlineData("00401CA4", "600009F0        	", "BRA.W  ", "$00402696            ")]
        [InlineData("00401CA8", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401CAA", "660000F6        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401CAE", "08070018        	", "BTST.L ", "#24,D7               ")]
        [InlineData("00401CB2", "660000EE        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401CB6", "3E3C0002        	", "MOVE.W ", "#$0002,D7            ")]
        [InlineData("00401CBA", "90C8            	", "SUBA.W ", "A0,A0                ")]
        [InlineData("00401CBC", "43F80400        	", "LEA    ", "($00000400).W,A1     ")]
        [InlineData("00401CC0", "4DFA0008        	", "LEA    ", "$00401cca(PC),A6     ")]
        [InlineData("00401CC4", "60000A2C        	", "BRA.W  ", "$004026f2            ")]
        [InlineData("00401CC8", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401CCA", "660000D6        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401CCE", "08070018        	", "BTST.L ", "#24,D7               ")]
        [InlineData("00401CD2", "660000CE        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401CD6", "4247            	", "CLR.W  ", "D7                   ")]
        [InlineData("00401CD8", "4DFA0008        	", "LEA    ", "$00401ce2(PC),A6     ")]
        [InlineData("00401CDC", "6000091E        	", "BRA.W  ", "$004025fc            ")]
        [InlineData("00401CE0", "2E46            	", "MOVEA.L", "D6, SP               ")]
        [InlineData("00401CE2", "7C00            	", "MOVEQ.L", "#0,D6                ")]
        [InlineData("00401CE4", "3E3C0005        	", "MOVE.W ", "#$0005,D7            ")]
        [InlineData("00401CE8", "4DFA0008        	", "LEA    ", "$00401cf2(PC),A6     ")]
        [InlineData("00401CEC", "60000C3C        	", "BRA.W  ", "$0040292a            ")]
        [InlineData("00401CF0", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401CF2", "660000AE        	", "BNE.W  ", "$00401da2            ")]
        [InlineData("00401CF6", "4247            	", "CLR.W  ", "D7                   ")]
        [InlineData("00401CF8", "0807001A        	", "BTST.L ", "#26,D7               ")]
        [InlineData("00401CFC", "661C            	", "BNE.B  ", "$00401d1a            ")]
        [InlineData("00401CFE", "2C4F            	", "MOVEA.L", "SP, A6               ")]
        [InlineData("00401D00", "3E7C0400        	", "MOVEA.W", "#$0400,SP            ")]
        [InlineData("00401D04", "41FAFCE4        	", "LEA    ", "$004019ea(PC),A0     ")]
        [InlineData("00401D08", "92C9            	", "SUBA.W ", "A1,A1                ")]
        ...
        [InlineData("00401D32", "4DFA0008        	", "LEA    ", "$00401d3c(PC),A6     ")]
        [InlineData("00401D36", "60000776        	", "BRA.W  ", "$004024ae            ")]
        [InlineData("00401D3A", "60000202        	", "BRA.W  ", "$00401f3e            ")]
        ...
        [InlineData("00401D4C", "45F900080000    	", "LEA    ", "($00080000).L,A2     ")]
        [InlineData("00401D52", "0C8000100000    	", "CMPI.L ", "#$00100000,D0        ")]
        [InlineData("00401D58", "6F06            	", "BLE.B  ", "$00401d60            ")]
        [InlineData("00401D5A", "45F900200000    	", "LEA    ", "($00200000).L,A2     ")]
        [InlineData("00401D60", "B2C8            	", "CMPA.W ", "A0,A1                ")]
        [InlineData("00401D62", "6F36            	", "BLE.B  ", "$00401d9a            ")]
        [InlineData("00401D64", "7C00            	", "MOVEQ.L", "#0,D6                ")]
        [InlineData("00401D66", "3E3C0003        	", "MOVE.W ", "#$0003,D7            ")]
        [InlineData("00401D6A", "B4C9            	", "CMPA.W ", "A1,A2                ")]
        [InlineData("00401D6C", "6C20            	", "BGE.B  ", "$00401d8e            ")]
        [InlineData("00401D6E", "B4C8            	", "CMPA.W ", "A0,A2                ")]
        [InlineData("00401D70", "6F18            	", "BLE.B  ", "$00401d8a            ")]
        [InlineData("00401D72", "48E700E0        	", "MOVEM.L", "A0-A2,-(SP)          ")]
        [InlineData("00401D76", "224A            	", "MOVEA.L", "A2,A1                ")]
        [InlineData("00401D78", "4DFA0008        	", "LEA    ", "$00401d82(PC),A6     ")]
        [InlineData("00401D7C", "60000974        	", "BRA.W  ", "$004026f2            ")]
        [InlineData("00401D80", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401D82", "661E            	", "BNE.B  ", "$00401da2            ")]
        ...
        [InlineData("00401D8E", "4DFA0008        	", "LEA    ", "$00401d98(PC),A6     ")]
        [InlineData("00401D92", "6000095E        	", "BRA.W  ", "$004026f2            ")]
        [InlineData("00401D96", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401D98", "6608            	", "BNE.B  ", "$00401da2            ")]
        ...
        [InlineData("00401DA6", "6604            	", "BNE.B  ", "$00401dac            ")]
        [InlineData("00401DA8", "6000F2EA        	", "BRA.W  ", "$00401094            ")]
        [InlineData("00401DAC", "60000190        	", "BRA.W  ", "$00401f3e            ")]
        ...
        [InlineData("00401DBC", "6726            	", "BEQ.B  ", "$00401de4            ")]
        [InlineData("00401DBE", "5340            	", "SUBQ.W ", "#1,D0                ")]
        [InlineData("00401DC0", "6700016A        	", "BEQ.W  ", "$00401f2c            ")]
        [InlineData("00401DC4", "5340            	", "SUBQ.W ", "#1,D0                ")]
        [InlineData("00401DC6", "6700016C        	", "BEQ.W  ", "$00401f34            ")]
        [InlineData("00401DCA", "5340            	", "SUBQ.W ", "#1,D0                ")]
        [InlineData("00401DCC", "6700016A        	", "BEQ.W  ", "$00401f38            ")]
        [InlineData("00401DD0", "5340            	", "SUBQ.W ", "#1,D0                ")]
        [InlineData("00401DD2", "671C            	", "BEQ.B  ", "$00401df0            ")]
        [InlineData("00401DD4", "5340            	", "SUBQ.W ", "#1,D0                ")]
        [InlineData("00401DD6", "6770            	", "BEQ.B  ", "$00401e48            ")]
        [InlineData("00401DD8", "5340            	", "SUBQ.W ", "#1,D0                ")]
        [InlineData("00401DDA", "6778            	", "BEQ.B  ", "$00401e54            ")]
        [InlineData("00401DDC", "6000014E        	", "BRA.W  ", "$00401f2c            ")]
        ...
        [InlineData("00401DF0", "B27A0BB2        	", "CMP.W  ", "$004029a4(PC),D1     ")]
        [InlineData("00401DF4", "6C000136        	", "BGE.W  ", "$00401f2c            ")]
        [InlineData("00401DF8", "E541            	", "ASL.W  ", "#2,D1                ")]
        [InlineData("00401DFA", "4BFA0BAA        	", "LEA    ", "$004029a6(PC),A5     ")]
        [InlineData("00401DFE", "32351000        	", "MOVE.W ", "0(A5,D1.W),D1        ")]
        [InlineData("00401E02", "4BF51000        	", "LEA    ", "0(A5,D1.W),A5        ")]
        [InlineData("00401E06", "4DFA000A        	", "LEA    ", "$00401e12(PC),A6     ")]
        [InlineData("00401E0A", "4ED5            	", "JMP    ", "(A5)                 ")]
        [InlineData("00401E0C", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401E0E", "6716            	", "BEQ.B  ", "$00401e26            ")]
        [InlineData("00401E10", "0807001D        	", "BTST.L ", "#29,D7               ")]
        [InlineData("00401E14", "670A            	", "BEQ.B  ", "$00401e20            ")]
        [InlineData("00401E16", "4DFA0004        	", "LEA    ", "$00401e1c(PC),A6     ")]
        [InlineData("00401E1A", "4ED5            	", "JMP    ", "(A5)                 ")]
        [InlineData("00401E1C", "0807001C        	", "BTST.L ", "#28,D7               ")]
        [InlineData("00401E20", "6608            	", "BNE.B  ", "$00401e2a            ")]
        [InlineData("00401E22", "5307            	", "SUBQ.B ", "#1,D7                ")]
        [InlineData("00401E24", "66E4            	", "BNE.B  ", "$00401e0a            ")]
        [InlineData("00401E26", "0807001E        	", "BTST.L ", "#30,D7               ")]
        [InlineData("00401E2A", "670C            	", "BEQ.B  ", "$00401e38            ")]
        [InlineData("00401E2C", "4DFA000C        	", "LEA    ", "$00401e3a(PC),A6     ")]
        [InlineData("00401E30", "600006CE        	", "BRA.W  ", "$00402500            ")]
        [InlineData("00401E34", "0807001F        	", "BTST.L ", "#31,D7               ")]
        [InlineData("00401E38", "670000F2        	", "BEQ.W  ", "$00401f2c            ")]
        [InlineData("00401E3C", "4E70            	", "RESET  ", "                     ")]
        [InlineData("00401E3E", "20780004        	", "MOVEA.L", "($00000004).W,A0     ")]
        ...
        [InlineData("00401E54", "6714            	", "BEQ.B  ", "$00401e6a            ")]
        [InlineData("00401E56", "7200            	", "MOVEQ.L", "#0,D1                ")]
        [InlineData("00401E58", "4DFA000C        	", "LEA    ", "$00401e66(PC),A6     ")]
        [InlineData("00401E5C", "60000098        	", "BRA.W  ", "$00401ef6            ")]
        [InlineData("00401E60", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401E62", "660000A2        	", "BNE.W  ", "$00401f06            ")]
        [InlineData("00401E66", "08070009        	", "BTST.L ", "#9,D7                ")]
        [InlineData("00401E6A", "6712            	", "BEQ.B  ", "$00401e7e            ")]
        [InlineData("00401E6C", "7201            	", "MOVEQ.L", "#1,D1                ")]
        [InlineData("00401E6E", "4DFA000A        	", "LEA    ", "$00401e7a(PC),A6     ")]
        [InlineData("00401E72", "60000082        	", "BRA.W  ", "$00401ef6            ")]
        [InlineData("00401E76", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401E78", "6600008C        	", "BNE.W  ", "$00401f06            ")]
        [InlineData("00401E7C", "0807000A        	", "BTST.L ", "#10,D7               ")]
        [InlineData("00401E80", "6710            	", "BEQ.B  ", "$00401e92            ")]
        [InlineData("00401E82", "7202            	", "MOVEQ.L", "#2,D1                ")]
        [InlineData("00401E84", "4DFA0008        	", "LEA    ", "$00401e8e(PC),A6     ")]
        [InlineData("00401E88", "606C            	", "BRA.B  ", "$00401ef6            ")]
        [InlineData("00401E8A", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401E8C", "6678            	", "BNE.B  ", "$00401f06            ")]
        [InlineData("00401E8E", "0807000B        	", "BTST.L ", "#11,D7               ")]
        [InlineData("00401E92", "6712            	", "BEQ.B  ", "$00401ea6            ")]
        [InlineData("00401E94", "7203            	", "MOVEQ.L", "#3,D1                ")]
        [InlineData("00401E96", "4DFA000A        	", "LEA    ", "$00401ea2(PC),A6     ")]
        [InlineData("00401E9A", "605A            	", "BRA.B  ", "$00401ef6            ")]
        [InlineData("00401E9C", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401E9E", "6666            	", "BNE.B  ", "$00401f06            ")]
        [InlineData("00401EA0", "0807000C        	", "BTST.L ", "#12,D7               ")]
        [InlineData("00401EA4", "6714            	", "BEQ.B  ", "$00401eba            ")]
        [InlineData("00401EA6", "7204            	", "MOVEQ.L", "#4,D1                ")]
        [InlineData("00401EA8", "4DFA000C        	", "LEA    ", "$00401eb6(PC),A6     ")]
        [InlineData("00401EAC", "6048            	", "BRA.B  ", "$00401ef6            ")]
        [InlineData("00401EAE", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401EB0", "6654            	", "BNE.B  ", "$00401f06            ")]
        [InlineData("00401EB2", "0807000D        	", "BTST.L ", "#13,D7               ")]
        [InlineData("00401EB6", "6716            	", "BEQ.B  ", "$00401ece            ")]
        [InlineData("00401EB8", "7205            	", "MOVEQ.L", "#5,D1                ")]
        [InlineData("00401EBA", "4DFA000E        	", "LEA    ", "$00401eca(PC),A6     ")]
        [InlineData("00401EBE", "6036            	", "BRA.B  ", "$00401ef6            ")]
        [InlineData("00401EC0", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401EC2", "6642            	", "BNE.B  ", "$00401f06            ")]
        [InlineData("00401EC4", "0807000E        	", "BTST.L ", "#14,D7               ")]
        [InlineData("00401EC8", "6718            	", "BEQ.B  ", "$00401ee2            ")]
        [InlineData("00401ECA", "7206            	", "MOVEQ.L", "#6,D1                ")]
        [InlineData("00401ECC", "4DFA0010        	", "LEA    ", "$00401ede(PC),A6     ")]
        [InlineData("00401ED0", "6024            	", "BRA.B  ", "$00401ef6            ")]
        [InlineData("00401ED2", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401ED4", "6630            	", "BNE.B  ", "$00401f06            ")]
        [InlineData("00401ED6", "0807000F        	", "BTST.L ", "#15,D7               ")]
        [InlineData("00401EDA", "673E            	", "BEQ.B  ", "$00401f1a            ")]
        [InlineData("00401EDC", "7207            	", "MOVEQ.L", "#7,D1                ")]
        [InlineData("00401EDE", "4DFA0012        	", "LEA    ", "$00401ef2(PC),A6     ")]
        [InlineData("00401EE2", "6012            	", "BRA.B  ", "$00401ef6            ")]
        [InlineData("00401EE4", "4A86            	", "TST.L  ", "D6                   ")]
        [InlineData("00401EE6", "661E            	", "BNE.B  ", "$00401f06            ")]
        [InlineData("00401EE8", "6030            	", "BRA.B  ", "$00401f1a            ")]
        [InlineData("00401EEA", "E341            	", "ASL.W  ", "#1,D1                ")]
        [InlineData("00401EEC", "4BFA0AB8        	", "LEA    ", "$004029a6(PC),A5     ")]
        ...
        [InlineData("00401EFE", "6712            	", "BEQ.B  ", "$00401f12            ")]
        [InlineData("00401F00", "4DFA000C        	", "LEA    ", "$00401f0e(PC),A6     ")]
        [InlineData("00401F04", "4ED5            	", "JMP    ", "(A5)                 ")]
        [InlineData("00401F06", "0807001C        	", "BTST.L ", "#28,D7               ")]
        [InlineData("00401F0A", "6600FF1E        	", "BNE.W  ", "$00401e2a            ")]
        [InlineData("00401F0E", "5307            	", "SUBQ.B ", "#1,D7                ")]
        [InlineData("00401F10", "6600FF42        	", "BNE.W  ", "$00401e54            ")]
        [InlineData("00401F14", "0887000F        	", "BCLR.L ", "#15,D7               ")]
        [InlineData("00401F18", "6600FF3A        	", "BNE.W  ", "$00401e54            ")]
        [InlineData("00401F1C", "6000FF0C        	", "BRA.W  ", "$00401e2a            ")]
        ...
        [InlineData("00401F2A", "6002            	", "BRA.B  ", "$00401f2e            ")]
        ...
        [InlineData("00401F36", "4DFA0014        	", "LEA    ", "$00401f4c(PC),A6     ")]
        [InlineData("00401F3A", "60000516        	", "BRA.W  ", "$00402452            ")]
        [InlineData("00401F3E", "4DFA0014        	", "LEA    ", "$00401f54(PC),A6     ")]
        [InlineData("00401F42", "600003AA        	", "BRA.W  ", "$004022ee            ")]
        [InlineData("00401F46", "4A45            	", "TST.W  ", "D5                   ")]
        [InlineData("00401F48", "6B00031A        	", "BMI.W  ", "$00402264            ")]
        [InlineData("00401F4C", "0205007F        	", "ANDI.B ", "#$7f,D5              ")]
        [InlineData("00401F50", "0C05002A        	", "CMPI.B ", "#$2a,D5              ")]
        [InlineData("00401F54", "6614            	", "BNE.B  ", "$00401f6a            ")]
        [InlineData("00401F56", "08C70013        	", "BSET.L ", "#19,D7               ")]
        [InlineData("00401F5A", "60000308        	", "BRA.W  ", "$00402264            ")]
        [InlineData("00401F5E", "08070013        	", "BTST.L ", "#19,D7               ")]
        [InlineData("00401F62", "670002C8        	", "BEQ.W  ", "$0040222c            ")]
        [InlineData("00401F66", "08870013        	", "BCLR.L ", "#19,D7               ")]
        [InlineData("00401F6A", "0C050053        	", "CMPI.B ", "#$53,D5              ")]
        [InlineData("00401F6E", "6618            	", "BNE.B  ", "$00401f88            ")]
        [InlineData("00401F70", "08870010        	", "BCLR.L ", "#16,D7               ")]
        [InlineData("00401F74", "08870016        	", "BCLR.L ", "#22,D7               ")]
        [InlineData("00401F78", "600002BE        	", "BRA.W  ", "$00402238            ")]
        [InlineData("00401F7C", "0C05004C        	", "CMPI.B ", "#$4c,D5              ")]
        [InlineData("00401F80", "6630            	", "BNE.B  ", "$00401fb2            ")]
        [InlineData("00401F82", "7404            	", "MOVEQ.L", "#4,D2                ")]
        [InlineData("00401F84", "4DFA0014        	", "LEA    ", "$00401f9a(PC),A6     ")]
        [InlineData("00401F88", "600003F2        	", "BRA.W  ", "$0040237c            ")]
        [InlineData("00401F8C", "2841            	", "MOVEA.L", "D1,A4                ")]
        [InlineData("00401F8E", "08070015        	", "BTST.L ", "#21,D7               ")]
        [InlineData("00401F92", "670002A4        	", "BEQ.W  ", "$00402238            ")]
        [InlineData("00401F96", "08870017        	", "BCLR.L ", "#23,D7               ")]
        [InlineData("00401F9A", "2001            	", "MOVE.L ", "D1,D0                ")]
        [InlineData("00401F9C", "7404            	", "MOVEQ.L", "#4,D2                ")]
        [InlineData("00401F9E", "4DFA029A        	", "LEA    ", "$0040223a(PC),A6     ")]
        [InlineData("00401FA2", "60000412        	", "BRA.W  ", "$004023b6            ")]
        [InlineData("00401FA6", "0C050042        	", "CMPI.B ", "#$42,D5              ")]
        [InlineData("00401FAA", "6630            	", "BNE.B  ", "$00401fdc            ")]
        [InlineData("00401FAC", "7402            	", "MOVEQ.L", "#2,D2                ")]
        [InlineData("00401FAE", "4DFA0014        	", "LEA    ", "$00401fc4(PC),A6     ")]
        [InlineData("00401FB2", "600003C8        	", "BRA.W  ", "$0040237c            ")]
        [InlineData("00401FB6", "3801            	", "MOVE.W ", "D1, D4               ")]
        [InlineData("00401FB8", "08070015        	", "BTST.L ", "#21,D7               ")]
        [InlineData("00401FBC", "6700027A        	", "BEQ.W  ", "$00402238            ")]
        [InlineData("00401FC0", "08870017        	", "BCLR.L ", "#23,D7               ")]
        [InlineData("00401FC4", "2001            	", "MOVE.L ", "D1, D0               ")]
        [InlineData("00401FC6", "7402            	", "MOVEQ.L", "#2,D2                ")]
        [InlineData("00401FC8", "4DFA0270        	", "LEA    ", "$0040223a(PC),A6     ")]
        [InlineData("00401FCC", "600003E8        	", "BRA.W  ", "$004023b6            ")]
        ...
        public void TestDisassembly(string addressString, string byteString, string op, string ea)
        {
            ...
            string assembly = record.Op.Assembly.RemoveMutipleWhiteSpaces();
            ...
            if (cleanOp != cleand0)
            {
                Debug.WriteLine($"Expected: '{cleanOp}', got '{cleand0}'");
            }
